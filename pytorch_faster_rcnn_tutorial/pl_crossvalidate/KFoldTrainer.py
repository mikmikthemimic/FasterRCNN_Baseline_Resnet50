...
from .datamodule import KFoldDataModule
...
class KFoldTrainer(Trainer):
    ...
    def __init__(self, num_folds: int = 5, shuffle: bool = False, stratified: bool = False, model_directory = None, *args, **kwargs) -> None:
    ...
    def cross_validate(
        ...
        path = osp.join(self.model_directory, "kfold_initial_weights.ckpt")
